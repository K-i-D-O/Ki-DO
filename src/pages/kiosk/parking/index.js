    ...
    <>
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-[calc(100%-48px)] px-[20px] bg-[#232323] pt-[20px] pb-[60px]">
        ...
        <div className="flex flex-col gap-y-[18px] items-center justify-center w-full overflow-y-auto  my-[5px] mb-[40px] pt-[70px] sm:pt-[16px] sm:mb-[20px]">
          ...
          <Link href="/kiosk/parking/m1" className="kiosk_mission_list duration-500 flex flex-row gap-x-[3px] items-center justify-between w-full border-[2px] border-primary rounded-[4px] hover:opacity-70 px-[16px] py-[15px] lg:py-[25px] bg-[#fff]">
            <div className="flex flex-col gap-y-[11px]">
              <p className="text-[#232323] text-[16px] lg:text-[18px] font-[700] tracking-[-0.8px] ">
                영수증 없이 주차정산을 해 볼까요?
                <br />
            ...
            <img className="w-[80px] sm:w-[110px] lg:w-[120px]" src="/imgs/parking/list-1.svg" alt="1단계 이미지" />
          </Link>
          <Link href="/kiosk/parking/m2" className="kiosk_mission_list duration-500 flex flex-row gap-x-[3px] items-center justify-between w-full border-[2px] border-primary rounded-[4px] hover:opacity-70 px-[16px] py-[15px] lg:py-[25px] bg-[#fff]">
            <div className="flex flex-col gap-y-[11px]">
              <p className="text-[#232323] text-[16px] lg:text-[18px] font-[700] tracking-[-0.8px] ">
                영수증으로 주차할인을 받아볼까요?
                <br />
            ...
            <img className="w-[80px] sm:w-[110px] lg:w-[120px]" src="/imgs/parking/list-2.svg" alt="2단계 이미지" />
          </Link>
        </div>
      </div>
    </>
