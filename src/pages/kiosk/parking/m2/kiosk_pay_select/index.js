      ...
      <div className="flex flex-col items-center justify-between w-full h-[calc(100%-48px)] bg-[#fff]">
        ...
        <div className="flex flex-col justify-center items-center gap-[12px] sm:gap-[20px] w-full h-full bg-[#fff] px-[20px] py-[5px] overflow-y-auto">
          ...
          <div className="w-full flex flex-col items-start gap-[2px] py-[8px] sm:py-[10px] px-[12px] bg-white border border-primary rounded-[8px]">
            <p className="text-[#000] text-[14px] lg:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left">총 금액 : 7000원</p>
            <p className="text-[#000] text-[14px] lg:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left">할인금액 : 4000원</p>
            <p className="text-primary text-[15px] lg:text-[17px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left">결제 할 금액 : 3000원</p>
          </div>
        </div>
      </div>
    </>
