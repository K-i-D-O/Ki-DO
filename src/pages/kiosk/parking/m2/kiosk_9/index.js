        ...
        <div className="flex flex-col justify-center items-center w-full h-full bg-[#fff] py-[20px]">
          <div className="flex flex-col items-center justify-center gap-[22px] w-full h-auto px-[40px]">
            <div className="w-full" href="#">
              <img className="w-[90%] mx-auto pointer-events-none mt-[20px]" src="/imgs/parking/parking_info_discount.svg" />
            </div>
            <Link href="./kiosk_pay_select" class="bg-primary flex items-center justify-center gap-x-[8px] py-[8px] px-[45px] rounded-[12px] text-[#fff] w-auto text-[20px] font-[700] tracking-[-0.8px] hover:opacity-70">
              <span>결제하기</span>
            </Link>
          </div>
        </div>
