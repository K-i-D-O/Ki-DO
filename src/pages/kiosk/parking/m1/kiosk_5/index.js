      ...
      <div className="flex flex-col items-center justify-between w-full h-[calc(100%-48px)] bg-[#fff]">
        ...
        <div className="flex flex-col justify-center items-center w-full h-full bg-[#fff]  max-w-[380px] py-[20px] px-[40px]">
          ...
          <div className="w-full grid grid-cols-4 gap-[8px] my-[15px] sm:my-[25px] px-[15px] sm:px-[5px]">
            ...
            <div className="w-full aspect-square flex items-center justify-center bg-[#232323]">
              <span className="text-[#fff] text-[30px] font-[700] tracking-[-0.8px]">6</span>
            </div>
            <div className="w-full aspect-square flex items-center justify-center bg-[#232323]">
              <span className="text-[#fff] text-[30px] font-[700] tracking-[-0.8px]">5</span>
            </div>
            <div className="w-full aspect-square flex items-center justify-center bg-[#232323]">
              <span className="text-[#fff] text-[30px] font-[700] tracking-[-0.8px]">0</span>
            </div>
          </div>
          <div className="w-full grid grid-cols-3 gap-[8px] px-[25px] sm:px-[15px]">
            ...
            <Link href="./kiosk_4" className="w-full aspect-square flex items-center justify-center bg-white border-[2px] border-[#232323] hover:opacity-70 hover:border-primary">
            ...
            <Link href="./kiosk_6" className="w-full aspect-square flex items-center justify-center bg-primary border-[2px] border-primary hover:opacity-70">
