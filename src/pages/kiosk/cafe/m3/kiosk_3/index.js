        ...
        <div className="flex flex-col  w-full h-[calc(100%-205px)] bg-[#d9d9d9]">
          ...
          <div className="grid grid-cols-3 gap-[15px] w-full h-auto bg-[#d9d9d9] py-[5px] px-[15px] overflow-y-auto my-[10px]">
            ...
            >
              ...
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">갸또쇼콜라</p>
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">6800원</p>
            </Link>
            <Link
              href="#"
              onClick={() => {
            ...
            >
              ...
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">생크림딸기</p>
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">6300원</p>
            </Link>
            <Link
              href="#"
              onClick={() => {
            ...
            >
              ...
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">바스크치즈</p>
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">6300원</p>
            </Link>
            ...
            >
              ...
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">얼그레이</p>
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">6500원</p>
            </Link>
            <Link
              href="#"
              onClick={() => {
            ...
            >
              ...
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">티라미수</p>
              <p className="text-[#000] text-[13px] sm:text-[16px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-center">5800원</p>
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-start w-[55%] h-full bg-[#fff] overflow-y-auto px-[10px] py-[12px]">
            ...
            >
              ...
              <div className="w-full flex flex-col">
                <p className="text-[#000] text-[14px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left">얼그레이 케이크 </p>
              </div>
              <p className="text-[#000] text-[14px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left">6500원</p>
            </Link>
          </div>
            ...
            <div className="flex flex-col justify-between items-center w-full h-full bg-[#fff]">
              <div className="w-full h-full flex flex-col justify-between items-end  p-[8px] border border-primary">
                ...
                <p className="text-[#000] text-[15px] font-[700] tracking-[-0.7px] leading-[155%] break-keep">
                  <span className="text-primary text-[20px] tracking-[-0.9px] font-[700]">6500</span>원
                </p>
              </div>
