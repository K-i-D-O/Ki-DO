          ...
          <form action="./kiosk_3" className="w-full h-[calc(100%-30px)] flex flex-col justify-between items-center border-[2px] border-primary rounded-[4px] px-[8px] py-[15px]">
            <div className="w-full">
              <div className="w-full flex items-center">
                <img className="w-[30%]" src="/imgs/cafe/coffee/1.png" />
                <div className="w-full">
                  <p className="text-[#000] text-[20px] lg:text-[22px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left mb-[5px] h-[30px]">[커피] 아메리카노</p>
                  <p className="text-primary text-[20px] lg:text-[22px] font-[700] tracking-[-0.7px] leading-[155%] break-keep text-left h-[30px]">3500원</p>
                </div>
              </div>
              ...
              <div className="w-full grid grid-cols-2 mb-[15px] gap-[8px]">
                <label
                  ...
                  tabindex="0"
                >
                  <input type="radio" name="hotice" value="hot" className="peer a11y opacity-0 w-0" disabled />
                  <div className="flex items-center justify-center w-full bg-[#FFFFFF] hover:bg-[#F5F5F5] peer-checked:bg-[#ff2f01] peer-checked:hover:bg-[#ff2f01]/90 border-[1px] border-[#DFDFDF] peer-checked:border-[#ff2f01] text-[#383838] peer-checked:text-[#FFFFFF]">
                    <p className="py-[9px] px-[8px] font-[500] text-[17px] leading-[16px] tracking-[-0.4px]">HOT</p>
                  </div>
                </label>
                <label className="flex cursor-pointer" tabindex="0">
                  <input type="radio" name="hotice" value="ice" className="peer a11y opacity-0 w-0" required="required" />
                  <div className="flex items-center justify-center w-full bg-[#FFFFFF] hover:bg-[#F5F5F5] peer-checked:bg-[#ff2f01] peer-checked:hover:bg-[#ff2f01]/90 border-[1px] border-[#DFDFDF] peer-checked:border-[#ff2f01] text-[#383838] peer-checked:text-[#FFFFFF]">
                    <p className="py-[9px] px-[8px] font-[500] text-[17px] leading-[16px] tracking-[-0.4px]">ICE</p>
                  </div>
                </label>
              </div>
            </div>
